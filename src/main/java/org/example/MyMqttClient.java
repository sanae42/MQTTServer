...
public class MyMqttClient {
    //An instance of the EMQX library's MqttClient class, a client class with a set of MQTT-related methods.
    private static MqttClient mqttClient = null;
    private static MemoryPersistence memoryPersistence = null;
    //An object that stores information related to connection settings
    private static MqttConnectOptions mqttConnectOptions = null;
    //Topic of the published message
    private String ClientId = "myMqttClient";
    //Server IP Address
    private static String IP = "47.98.247.122";
    //A list storing all topics to which the client is subscribed
